...
\subsection{Summary of Low-level Optimizations and Results for Quadrature Representation}
To neatly distinguish the contributions of this paper from those in~\cite{Luporini}, we summarize in this section the results of our previous work on automated code transformation for quadrature representation.
...
\subsection{Avoiding Operations on Zeros}
