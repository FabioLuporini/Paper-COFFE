...
\subsection{Transformation Space - Introducing Pre-evaluation}
...
\item The transformations exposing pre-evaluation opportunities could increase the arithmetic complexity (e.g., expansion may increase the operation count; further examples will be provided later). This could outweigh the gain due to pre-evaluation.
\end{itemize}
...
We expand on these points in Section~\ref{sec:optimal-synthesis}. In the perspective of addressing point 2), we provide a more refined definition of optimality.
...
Sharing elimination and pre-evaluation (and, as we will clarify, their composition) allow us to explore all ways in which spatial and temporal redundancy can be eliminated from loop nests and expressions as in Definition~\ref{def:fem-loopnest}.
