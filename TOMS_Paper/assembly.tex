...
\item \textit{strategy (i)} and \textit{strategy (ii)}: the two approaches described in Section~\ref{sec:se-rln} for handling structured sub-expressions.
\end{itemize}
