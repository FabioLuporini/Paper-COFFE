...
\begin{itemize}
\item We define optimality for finite element integration. We study the transformation space for loops and expressions within which the optimal is sought.
...
\item We state for which class of problems optimality can be reached, and for which class heuristics are instead needed to minimize the operation count.
