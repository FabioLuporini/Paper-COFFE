...
\begin{itemize}
\item FEniCS Form Compiler's built-in optimization system: optimized quadrature mode (work presented in~\citeN{quadrature1}). Referred to as \texttt{quad} 
\item FEniCS Form Compiler's built-in optimization system: tensor mode (work presented in~\citeN{FFC-TC}). Referred to as \texttt{tens} 
\item FEniCS Form Compiler's built-in optimization system: automatic mode (choice between \texttt{tens} and \texttt{quad} driven by heuristic, discussed in~\citeN{Fenics}). Referred to as \texttt{auto} 
