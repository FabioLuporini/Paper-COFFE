...
% Page heads
\markboth{F. Luporini et al.}{An algorithm for the optimization of finite element integration}

% Title portion

\title{An algorithm for the optimization of finite element integration}
...
\acmformat{Fabio Luporini, David A. Ham, and Paul H. J. Kelly, 2016. An algorithm for the optimization of finite element integration.}
