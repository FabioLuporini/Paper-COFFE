...
%; if multiple partitions have same cost, the preference is for the one with the largest occurrences in the input expression.
...
%TODO : this needs to be applied to all lifted sub-expressions as well
\end{enumerate}
\end{Algo}
